function ColTest_CircleORect(state_machine_id) : RenderState(state_machine_id) constructor {
	s1 = noone;
	s2 = noone;
	...
	static process_input = function() {
		if (keyboard_check_pressed(vk_space)) state_machine.change("rect-orect");
	}
	...
	static update = function(dt) {
		...
		if (collide_circle_in_oriented_rectangle(s1.shape,s2.shape)) {
	...
	static draw = function() {
		draw_text(1,1,"Circle-Oriented Rectangle Collisions");
