function ColTest_LineCircle(state_machine_id) : RenderState(state_machine_id) constructor {
	s1 = noone;
	s2 = noone;
	...
	static process_input = function() {
		if (keyboard_check_pressed(vk_space)) state_machine.change("line-rect");
	}
	...
	static update = function(dt) {
		...
		if (collide_line_in_circle(s1.shape,s2.shape)) {
	...
	static draw = function() {
		draw_text(1,1,"Line-Circle Collisions");
